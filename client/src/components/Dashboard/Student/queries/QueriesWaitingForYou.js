...
function QueriesWaitingForYou() {
    ...
    // to solve a query asked by fellow students
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" placeholder="Write your query here" rows="4" cols="50" onChange={(e) => {
...
export default QueriesWaitingForYou;