...
function FacultyLogin() {
    ...
    // validate faculty credentials for login
    function validate(event) {
        ...
        console.log(faculty);
        axios
            .post(`${getServerUrl()}/api/faculty/login`, faculty)
            .then((res) => {
    ...
    function forgotPasswordFunc(e) {
        ...
        axios
            .post(`${getServerUrl()}/api/faculty/forgot-password`, forgotPasswordObj)
            .then((res) => {
    ...
    return (
        <div>
            {!forgotPassword ? (
                ...
                : <Resetpassword email={emailId} userType="FAC" />}
        </div>
    );
}
